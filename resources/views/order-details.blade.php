                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <span class="badge bg-{{ $order->status_badge }} bg-opacity-25 text-dark border border-{{ $order->status_badge }} rounded-pill px-4 py-3 fs-6">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-card position-relative cursor-pointer" 
                                    ...
                                    <div class="position-relative">
                                        ...
                                        @endif
                                        <span class="position-absolute top-0 end-0 translate-middle badge bg-primary rounded-circle px-2 py-1 m-1">
                                            {{ $item->quantity }}
                                        </span>
                                    </div>
                                    <div class="mt-2">
                                        <h6 class="small fw-semibold mb-1 text-truncate">{{ $item->product_name }}</h6>
                                        <div class="small text-primary fw-bold">₹{{ number_format($item->total, 2) }}</div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="mt-4 pt-3 border-top">
                            <button class="btn btn-primary w-100 py-3 rounded-3 fw-semibold"
                                    data-bs-toggle="modal" 
                                    data-bs-target="#orderItemsModal">
                    ...
                    <div class="border-top pt-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="bullet bg-{{ $order->payment_status == 'paid' ? 'success' : 'warning' }}"></div>
            ...
            <div class="modal-header border-0 pb-0">
                <div class="w-100">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div>
                            <h4 class="modal-title fw-bold" id="orderItemsModalLabel">Order Items ({{ $order->items->count() }})</h4>
                            <p class="text-muted small mb-0">Order #{{ $order->order_number }}</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card border-0 bg-light bg-opacity-50 h-100">
                                <div class="card-body">
                                    <div class="position-relative mb-3">
                                        ...
                                        @endif
                                        <span class="position-absolute top-0 start-0 translate-middle badge bg-primary rounded-pill px-3 py-2 m-3">
                                            {{ $item->quantity }} ×
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            ...
                                            <div class="h5 fw-bold text-primary">₹{{ number_format($item->total, 2) }}</div>
                                        </div>
                                    </div>
