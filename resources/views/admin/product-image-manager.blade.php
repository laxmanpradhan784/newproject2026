                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <span class="badge {{ $selectedProduct->images->count() == 5 ? 'bg-danger' : 'bg-success' }}">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#viewModal">
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        @if($selectedProduct)
                            ...
                            <a href="#viewModal" class="btn btn-info" data-bs-toggle="modal" data-bs-dismiss="modal">
            ...
            <div class="modal-body">
                @if($selectedProduct && $selectedProduct->images->count() > 0)
                    ...
                    <div class="text-center mt-4">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadModal" data-bs-dismiss="modal">
