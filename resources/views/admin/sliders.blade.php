...
@section('content')
                            ...
                            <tr class="bg-light">
                                <th class="ps-4 py-3 align-middle" style="width: 90px;">
                                    <span class="bg-primary bg-opacity-10 p-1 rounded-2">
                                        <i class="bi bi-hash text-primary fs-6">No</i>
                                    </span>
                                </th>
                                <th class="ps-4 py-3 align-middle" style="width: 120px;">
                                ...
                                <th class="py-3 align-middle text-center">
                                    <span class="badge bg-light text-dark border d-inline-flex align-items-center gap-1">
                                        <i class="bi bi-circle-fill text-secondary" style="font-size: 6px;"></i>
                                        Status
                                    </span>
                                </th>
                                <th class="pe-4 py-3 align-middle text-end" style="width: 180px;">
                            ...
                            @forelse($sliders as $slider)
                                <tr class="hover-row">
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('slider.update-status', $slider->id) }}" method="POST"
                                            class="d-inline-block">
                                            @csrf
                                            @method('PUT')
                                            <input type="hidden" name="status"
                                                value="{{ $slider->status == 'active' ? 'inactive' : 'active' }}">
    ...
    <div class="modal fade" id="deleteSliderModal" tabindex="-1" aria-labelledby="deleteSliderModalLabel"
        aria-hidden="true">
                ...
                <form method="POST" action="{{ route('admin.sliders.delete', ':id') }}" id="deleteSliderForm">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p class="text-muted">This slider will be permanently deleted. This action cannot be undone.
                            </p>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            input.addEventListener('change', function(e) {
                if (this.files && this.files[0]) {
                    ...
                    reader.onload = function(e) {
                        preview.innerHTML =
                            `<img src="${e.target.result}" style="max-width: 100%; max-height: 150px;" class="rounded border">`;
                    }
