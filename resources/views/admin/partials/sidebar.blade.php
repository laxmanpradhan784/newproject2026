<aside class="admin-sidebar police-sidebar" style="width: 250px; min-height: 87vh;">
    ...
    <!-- Glowing User Badge -->
    <div class="user-badge-section p-3 border-bottom border-secondary"
        style="background: linear-gradient(90deg, rgba(0,0,0,0.3) 0%, rgba(67,97,238,0.1) 100%);">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('admin.dashboard') }}"
                    class="nav-link police-nav-link d-flex align-items-center px-3 py-2 rounded-3 active">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('admin.reviews.index') }}"
                    class="nav-link police-nav-link d-flex align-items-center px-3 py-2 rounded-3 {{ request()->is('admin/reviews*') ? 'active' : '' }}">
                    <div class="nav-icon me-3">
