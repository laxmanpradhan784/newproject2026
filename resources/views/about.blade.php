                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-primary me-2"></i>
                                Innovation in shopping technology
                            </li>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-primary me-2"></i>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="value-card text-center p-4 h-100">
                    ...
                    <p class="text-muted">
                        ...
                        learn, and we continuously improve to meet their needs.
                    </p>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="value-card text-center p-4 h-100">
                    ...
                    <p class="text-muted">
                        We embrace change and constantly seek new ways to enhance the
                        shopping experience through technology and creativity.
                    </p>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="timeline-card p-4 h-100">
                        ...
                        <p>
                            Founded as a small online bookstore with just 3 employees in a
                ...
                <div class="col-md-4 mb-4">
                    <div class="timeline-card p-4 h-100">
                        ...
                        <p>
                            Expanded product categories to include electronics and home
                            appliances. Reached 100,000 customers.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="timeline-card p-4 h-100">
                        ...
                        <p>
                            Launched international shipping to 50+ countries. Won "Best
                            E-commerce Platform" award.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="timeline-card p-4 h-100">
                        ...
                        <p>
                            Launched our mobile app with 1 million downloads in the first
                            month. Expanded to 200+ employees.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="timeline-card p-4 h-100">
                        ...
                        <p>
                            Launched contactless delivery and supported small businesses
                            during the pandemic. Reached 5M customers.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="timeline-card p-4 h-100">
                        ...
                        <p>
                            Serving 10M+ customers worldwide with 50K+ products. Focus on AI
        ...
        <div class="row g-4">
                ...
                <div class="team-card text-center">
                    <div class="team-img mb-4">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                            alt="CEO" class="img-fluid rounded-circle"
                            style="width: 150px; height: 150px; object-fit: cover" />
                    </div>
                    <h4 class="fw-bold mb-2">John Smith</h4>
                    <p class="text-primary mb-3">Founder & CEO</p>
                    <p class="text-muted small">
                        With 15+ years in e-commerce, John leads our vision and strategic
                        direction.
                    </p>
            ...
            <div class="col-md-4">
                <div class="team-card text-center">
                    <div class="team-img mb-4">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                            alt="CTO" class="img-fluid rounded-circle"
                            style="width: 150px; height: 150px; object-fit: cover" />
                    </div>
                    <h4 class="fw-bold mb-2">Sarah Johnson</h4>
                    <p class="text-primary mb-3">Chief Technology Officer</p>
                    <p class="text-muted small">
                        Sarah leads our tech team and drives innovation in our platform
                        development.
                    </p>
                    <div class="social-links mt-3">
                        <a href="#" class="text-muted me-3">
                ...
                <div class="team-card text-center">
                    <div class="team-img mb-4">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                            alt="COO" class="img-fluid rounded-circle"
                            style="width: 150px; height: 150px; object-fit: cover" />
                    </div>
                    <h4 class="fw-bold mb-2">Michael Chen</h4>
                    <p class="text-primary mb-3">Chief Operations Officer</p>
                    <p class="text-muted small">
                        Michael ensures smooth operations and excellent customer experience
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                ...
                <a href="{{ route('contact') }}" class="btn btn-outline-light btn-lg ms-3 px-5">
                    Contact Us
                </a>
            </div>
        </div>
