               ...
               @php
                ...
                <div class="social-icons mt-4">
                    ...
                    @if($site && $site->twitter)
                        <a href="{{ $site->twitter }}" target="_blank" class="social-icon twitter me-3"
                        title="Twitter">
                    ...
                    @if($site && $site->youtube)
                        <a href="{{ $site->youtube }}" target="_blank" class="social-icon youtube me-3"
                        title="YouTube">
                    ...
                    @if(!$site || (!$site->facebook && !$site->twitter && !$site->instagram && !$site->linkedin && !$site->youtube && !$site->pinterest))
