    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <p class="text-light">Your one-stop destination for all your shopping needs. Quality products, best prices, and exceptional customer service.</p>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#" class="text-light text-decoration-none">Shop</a></li>
                    <li class="mb-2"><a href="#" class="text-light text-decoration-none">Categories</a></li>
                    <li class="mb-2"><a href="#" class="text-light text-decoration-none">Deals</a></li>
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#" class="text-light text-decoration-none">Books</a></li>
