...
<section class="checkout-page py-5 bg-light">
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="checkout-steps d-flex justify-content-between position-relative">
                    <div class="step active text-center">
                        <div class="step-icon bg-primary text-white rounded-circle mx-auto mb-2">
                            <i class="fas fa-shopping-cart"></i>
                        </div>
                        <span class="step-text small">Cart</span>
                    </div>
                    <div class="step active text-center">
                        <div class="step-icon bg-primary text-white rounded-circle mx-auto mb-2">
                            <i class="fas fa-user"></i>
                        </div>
                        <span class="step-text small">Information</span>
                    </div>
                    <div class="step text-center">
                        <div class="step-icon bg-secondary text-white rounded-circle mx-auto mb-2">
                            <i class="fas fa-truck"></i>
                        </div>
                        <span class="step-text small">Shipping</span>
                    </div>
                    <div class="step text-center">
                        <div class="step-icon bg-secondary text-white rounded-circle mx-auto mb-2">
                            <i class="fas fa-credit-card"></i>
                        </div>
                        <span class="step-text small">Payment</span>
                    </div>
                    <div class="step text-center">
                        <div class="step-icon bg-secondary text-white rounded-circle mx-auto mb-2">
                            <i class="fas fa-check"></i>
                        </div>
                        <span class="step-text small">Complete</span>
                    </div>
                ...
                <form action="{{ route('checkout.store') }}" method="POST" id="checkoutForm">
                    ...
                    <div class="card rounded-3 shadow-sm border-0 mb-4">
                        <div class="card-header bg-white border-0 py-3">
                            <h4 class="mb-0"><i class="fas fa-shipping-fast text-primary me-2"></i> Shipping Information</h4>
                        </div>
                        <div class="card-body">
                            <!-- Contact Information -->
                            <div class="row mb-4">
                    ...
                    <div class="card rounded-3 shadow-sm border-0">
                        <div class="card-header bg-white border-0 py-3">
                            <h4 class="mb-0"><i class="fas fa-credit-card text-primary me-2"></i> Payment Information</h4>
                        </div>
                        <div class="card-body">
                            <!-- Payment Method -->
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="payment-option text-center">
                                            <input type="radio" name="payment_method" id="cod" value="cod" class="d-none" checked>
                                            <label for="cod" class="payment-label border rounded p-3 d-block h-100">
                                    ...
                                    <div class="col-md-4">
                                        <div class="payment-option text-center">
                                            ...
                                            <label for="card" class="payment-label border rounded p-3 d-block h-100">
                                    ...
                                    <div class="col-md-4">
                                        <div class="payment-option text-center">
                                            ...
                                            <label for="upi" class="payment-label border rounded p-3 d-block h-100">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg w-100 py-3 fw-bold">
                                <i class="fas fa-lock me-2"></i> Place Order & Pay ₹<span id="finalTotal">{{ number_format($total, 2) }}</span>
                            </button>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="card-body">
                        ...
                        <div class="total-amount mb-4">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="h4 fw-bold text-primary" id="displayTotal">₹{{ number_format($total, 2) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('styles')
<style>
    .checkout-page { min-height: calc(100vh - 200px); }
    .checkout-steps { max-width: 800px; margin: 0 auto; }
    .step-icon {
    ...
    .step.active .step-icon { background: #0d6efd !important; }
    .payment-label {
        cursor: pointer; transition: all 0.3s ease;
    }
    .payment-label:hover { border-color: #0d6efd !important; transform: translateY(-2px); }
    ...
    @media (max-width: 768px) {
        ...
        .step-icon { width: 30px; height: 30px; font-size: 0.8rem; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotals() {
        const isExpress = document.querySelector('input[name="shipping_method"]:checked').value === 'express';
        const shipping = isExpress ? 150 : (subtotal > 1000 ? 0 : 50);
        const tax = subtotal * taxRate;
        const total = subtotal + shipping + tax;
        
        // Update display
        document.getElementById('displayShipping').textContent = shipping === 0 ? 'FREE' : '₹' + shipping.toFixed(2);
