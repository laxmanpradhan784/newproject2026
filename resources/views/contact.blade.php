    ...
    <div class="container pt-5">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="lead mb-4">Have questions? We're here to help! Reach out to us through any of the channels below.</p>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="subject" name="subject" class="form-select" required>
                                            ...
                                            <option value="Order Issues" {{ old('subject') == 'Order Issues' ? 'selected' : '' }}>Order Issues</option>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea id="message" name="message" class="form-control" 
                                              rows="6" placeholder="How can we help you?" required>{{ old('message') }}</textarea>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                ...
                <div class="text-center mt-5">
                    <p class="mb-0">
                        Still have questions? <a href="#contactForm" class="text-primary fw-bold">Send us a message</a> or check our <a href="#" class="text-primary fw-bold">Help Center</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-4">
                <div class="text-center p-4">
                    ...
                    <p class="text-muted">Your information is secure with us. We never share your data with third parties.</p>
