...
<body>
    ...
    <div class="alert alert-success alert-dismissible fade show mb-0 rounded-0" role="alert" style="border-left: 5px solid #198754;">
        <div class="container">
    ...
    <div id="cartSessionData" 
         data-guest-token="{{ session('guest_token') }}"
